    ...
    <div style={{ background: "#0f0f0f", color: "#f0efe8", overflowX: "hidden" }}>
      <style>{`
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ── FOOTER INNER — same 80% centered wrapper as specs ── */
        .footer-inner {
          width: 80%;
          max-width: 1400px;
          margin: 0 auto;
        ...
        .footer-top {
          ...
          grid-template-columns: clamp(200px, 22vw, 320px) 1fr;
          gap: clamp(32px, 5vw, 80px);
          padding: clamp(40px, 5vw, 72px) 0 clamp(32px, 4vw, 64px);  /* side padding 0 — handled by footer-inner */
          border-bottom: 1px solid rgba(255,255,255,0.06);
        }
        .footer-brand p {
          color: #555;
        ...
        .footer-bottom {
          display: flex; justify-content: space-between; align-items: center;
          padding: 24px 0;   /* side padding 0 — handled by footer-inner */
          flex-wrap: wrap; gap: 12px;
        }
        .footer-copy { color: #333; font-size: clamp(0.8rem, 0.85vw, 0.9rem); }
        .footer-legal { display: flex; gap: clamp(12px, 1.5vw, 24px); }
      ...
      <div style={{ position: "relative", zIndex: 10 }}>
        <div ref={sectionRef} style={{ height: SCROLL_HEIGHT, position: "relative" }}>
          ...
          >
            ...
            {/* FOOTER — background #0d0d0d full width, content centered via footer-inner */}
            <footer className="site-footer">
